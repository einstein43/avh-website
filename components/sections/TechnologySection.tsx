    ...
    <section id="tech" className="py-20 px-4">
      <div ref={elementRef} className="max-w-7xl mx-auto">
        ...
        <div className="grid gap-8" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))' }}>
          <div className={`transition duration-700 delay-100 ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}>
            <TechCard
              icon={Brain}
          ...
          <div className={`transition duration-700 delay-200 ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}>
            <TechCard
              icon={Zap}
          ...
          <div className={`transition duration-700 delay-300 ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}>
            <TechCard
              icon={Code}
          ...
          <div className={`transition duration-700 delay-500 ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}>
            <TechCard
              icon={Database}
