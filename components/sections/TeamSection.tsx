      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid gap-8" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))' }}>
          {team.members.map((member, idx) => (
            ...
            >
              <div className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur p-6 rounded-2xl border border-white/10 hover:border-purple-500/30 transition duration-300 h-full group">
                {/* Avatar */}
